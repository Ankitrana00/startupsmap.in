...
export function GridContainer({
  ...
  if (startups.length === 0) {
    return <EmptyState message="No startups match these filters yet." />;
  }
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center gap-2 px-4 pb-6">
        ...
        {/* M7: 14px (was 12px) — this is the only place the user sees how many
            of how many are shown, and it pairs muted-foreground with small text. */}
